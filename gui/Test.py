...
class HandheldMenu(QMainWindow): # creates class with QMainWindow being its mother code
    def __init__(self):
        ...
        main_layout = QVBoxLayout()  # Vertical layout for stacking two rows of buttons

        # upper buttons setup
        upper_layout = QHBoxLayout()
        upper_layout.setContentsMargins(120, 120, 120, 120) #sets spaces between widgets(left, top, right, bottom)
        ...
        lower_layout.setContentsMargins(140, 225, 140, 225) #sets spaces between widgets(left, top, right, bottom)
                                                                        #100px
